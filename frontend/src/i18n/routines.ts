...
export const STRINGS: Record<string, { en: string; es: string }> = {
  ...
  limitReached: { en: 'Weekly limit reached · clock out, then request a time change under Hours & pay', es: 'Limite semanal alcanzado · sal y pide un cambio de horas en Horas y pago' },
