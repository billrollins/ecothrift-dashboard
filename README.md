...
| [`.ai/protocols/review.1.Deep.md`](.ai/protocols/review.1.Deep.md) | Full repo/context audit; human-readable reports + `PLAN.md` under `.ai/reference/deep_dive/latest/`. |
