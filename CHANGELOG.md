...
- **Steering / process** — **`review.0.Bump`** (**2026-05-02**, second pass): committed **`.ai/reference/`** Final Review pointers (**`fix_this.md`**, **`final_review_*`**, **`processing_data_lifecycle.md`**) so **`[Unreleased]`** links resolve; **`frontend/package.json`** **`0.0.0`** unchanged; **no** `.version` bump (Part **2A**).
