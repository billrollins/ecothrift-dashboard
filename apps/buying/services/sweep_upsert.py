...
INSERT INTO buying_auction (
    ...
    pallet_count, origin_city, origin_zip, shipment_type,
...
ON CONFLICT (marketplace_id, external_id) DO UPDATE SET
    ...
    pallet_count = COALESCE(EXCLUDED.pallet_count, buying_auction.pallet_count),
    origin_city = COALESCE(NULLIF(EXCLUDED.origin_city, ''), buying_auction.origin_city),
    origin_zip = COALESCE(NULLIF(EXCLUDED.origin_zip, ''), buying_auction.origin_zip),
    shipment_type = COALESCE(NULLIF(EXCLUDED.shipment_type, ''), buying_auction.shipment_type),
    ...
    with connection.cursor() as cur:
        for raw in listings:
            ...
            row_vals = (
                ...
                fields.get('pallet_count'),
                fields.get('origin_city') or '',
                fields.get('origin_zip') or '',
                fields.get('shipment_type') or '',
