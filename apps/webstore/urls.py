...
urlpatterns = [
    ...
    path('images/<int:image_id>/display/', listing_image_display, name='webstore-image-display'),
    path('images/<int:image_id>/<slug:slot>/', listing_image_slot, name='webstore-image-slot'),
