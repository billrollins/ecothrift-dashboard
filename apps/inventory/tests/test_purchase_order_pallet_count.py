"""API behavior for optional PO `pallet_count` (planning / expectation)."""
...
class PurchaseOrderPalletCountTests(TestCase):
    ...
    def test_post_includes_pallet_count_and_get_returns_it(self):
        payload = {
        ...
        self.assertEqual(r.data['pallet_count'], 12)

        rid = r.data['id']
        r2 = self.client.get(f'/api/inventory/orders/{rid}/')
        self.assertEqual(r2.status_code, 200)
        self.assertEqual(r2.data['pallet_count'], 12)
