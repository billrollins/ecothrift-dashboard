<!-- Last updated: 2026-05-18 (steering cleanup: version/changelog at repo root only; initiative = plan) -->
...
- **Plan + sessions:** [`.ai/initiatives/order_processing_pipeline_rebuild.md`](initiatives/order_processing_pipeline_rebuild.md) ([`_index.md`](initiatives/_index.md)).
- **Inbound intake reference:** [`.ai/reference/order_processing_pipeline_rebuild/`](reference/order_processing_pipeline_rebuild/README.md) (`_sql/`, `_recon/`, field map).
- **Final Review UI (pending visual pass):** [`.ai/reference/fix_this.md`](reference/fix_this.md).
