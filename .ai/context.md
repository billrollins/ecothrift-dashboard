<!-- Last updated: 2026-05-18 (**review.0/1/9** pass; **Session 15** intake rebuild on working tree + **`CHANGELOG [Unreleased]`**; deep-dive **`.ai/reference/deep_dive/latest/`** refreshed; **`extended/sql/`** prior) -->
