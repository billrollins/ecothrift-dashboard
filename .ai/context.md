...
- **Active — Online Sales MVP:** [`online_sales_mvp`](initiatives/online_sales_mvp.md) — **v2.62.0–v2.63.0** staff workspace + Listing Studio polish + shared TipTap `RichTextEditor`; public surface still **parked** (`ONLINE_SALES_ENABLED=false`). Next: two-way M365 Graph mail (v2.64). Narrows parked [`online_sales_workspace`](initiatives/_archived/_pending/online_sales_workspace.md).
