<!-- Last updated: 2026-08-11 (online_sales_mvp archived completed; Active empty) -->
...
- **No active initiative.** Start the next one via [`.ai/protocols/code.0.Startup.md`](protocols/code.0.Startup.md) + [`.ai/initiatives/_index.md`](initiatives/_index.md) (Active is empty).
