...
**Current version:** See repo root `.version` (e.g. `v2.8.0`). **Buying Phase 5** (valuation APIs) shipped **v2.8.0**; documented in **`.ai/initiatives/bstock_auction_intelligence.md`** and **`.ai/extended/backend.md`**. React UI for valuation columns not fully wired.
