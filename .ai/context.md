<!-- Last updated: 2026-05-02 (**v2.21.1** — Processing data hotfix: fast minimal `build-processing-data`, duplicate scan removed — `CHANGELOG [2.21.1]`) -->
