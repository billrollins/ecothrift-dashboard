...
**Current version:** See repo root `.version` (e.g. `v2.7.1`).
...
- **Buying Phase 5:** auction valuation scaffold — **blocked on** [historical sell-through analysis](initiatives/historical_sell_through_analysis.md) Phase **3** output (pricing rules); implementation follows per [bstock initiative](initiatives/bstock_auction_intelligence.md)
