...
- **ACTIVE (compass) — Buying intelligence v2:** [`buying_intelligence_v2`](initiatives/buying_intelligence_v2.md). It has 5 phases, each shipped to production on its own: QA inbox, then vector text, then the price and speed model (truck value v3), then the self-running buying loop, then the Buying workspace. v2.105.0 is live (Heroku v363), with seller factors saved in production. The earlier buying work is [`bstock_daily_buying`](initiatives/bstock_daily_buying.md) (Phases 1–6 done).
