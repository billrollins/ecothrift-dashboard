<!-- Last updated: 2026-05-01 (**v2.21.0** — Item Processor `ProcessingRow` + paginated workspace + lazy row detail; swap removed — `CHANGELOG [2.21.0]`; Final Review mockup pending — `fix_this.md`) -->
