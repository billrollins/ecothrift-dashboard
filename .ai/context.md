<!-- Last updated: 2026-05-02 (Item Processor read-only pricing audit + `manual-review` Retail; Final Review mockup pending — `fix_this.md`; `review.0.Bump`) -->
