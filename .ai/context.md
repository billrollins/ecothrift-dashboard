<!-- Last updated: 2026-05-02 (**v2.22.1** — Item Processor timeout hotfix: slim PO queryset + no manifest prefetch storm; `CHANGELOG [2.22.1]`) -->
