<!-- Last updated: 2026-08-13 (work-bench table pointer → TarsGradeTable) -->
...
**Initiative:** [`finalize_tars_app`](../../initiatives/_archived/_completed/finalize_tars_app.md) (canon written under the superseded `tars_full_instruction_wizard_guidance` initiative)

Discovery workbook (Phase 0 evidence pack) was removed from the repo 2026-08-13; this canon is the surviving process document.
...
- Early product prototype `TARS.dc.html` and the Phase 0 discovery workbook were removed from the repo 2026-08-13 (recover from git history if needed).
...
- Grade table: [`TarsGradeTable.tsx`](../../../frontend/src/pages/restoration/tars/TarsGradeTable.tsx)
