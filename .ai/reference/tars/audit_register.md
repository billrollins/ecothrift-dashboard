...
**Initiative:** [`finalize_tars_app`](../../initiatives/_archived/_completed/finalize_tars_app.md) — Stage 1 (Audit)
...
| D4  | TARS.dc.html (removed 2026-08-13)                                  | Original prototype; source of intent, not a contract. Recover from git history if needed. |         |     |       |
...
*Parent:* [`finalize_tars_app`](../../initiatives/_archived/_completed/finalize_tars_app.md) · *Design:* [`design.md`](./design.md)