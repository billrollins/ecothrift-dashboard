...
**2026-07-22 (v2.55.0) — Delivery Desk/Field foundation:** `/pos/deliveries` redirects to saved Desk/Field experience; inactive **Days** + **Total Deliveries** under `/pos/deliveries/desk/*` and `/pos/deliveries/field/*`; legacy active board at `/pos/deliveries/legacy`. Canonical hooks in `hooks/useDelivery.ts`.
