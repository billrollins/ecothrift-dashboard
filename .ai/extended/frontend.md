...
**Restoration — TARS (`TarsWorkspacePage`, `/restoration/tars`):** Phase 0 mock — **Send to Restoration | Check-In & Evaluate | TARS** pages; evaluation summary + verb queues under active evaluation. Initiative: [`.ai/initiatives/tars_restoration_workspace.md`](../initiatives/tars_restoration_workspace.md).
