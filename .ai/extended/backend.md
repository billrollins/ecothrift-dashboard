<!-- Last updated: 2026-05-06 (**v2.23.0** — `ProcessingRow.search_string` + workspace `searchString` + `rebuild_processing_search_string` — **`CHANGELOG [2.23.0]`**) -->
