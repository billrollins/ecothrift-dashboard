...
| Initiative | Notes |
|------------|--------|
| [bstock_auction_intelligence.md](./bstock_auction_intelligence.md) | B-Stock: Phases **1–4** + **4.1A** complete (**v2.6.1** — manifest templates, CSV upload, fast-cat seed, buying UI polish); **next Phase 5** auction valuation; then outcomes (**Phase 6**). |
