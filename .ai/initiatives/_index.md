...
| Initiative | Notes |
|------------|--------|
| [bstock_auction_intelligence.md](./bstock_auction_intelligence.md) | B-Stock: Phases **1–4** complete (**v2.6.0** — includes polling, snapshots, price history, categorization); **next Phase 5** auction valuation; then outcomes (**Phase 6**). |
