...
| [ui_ux_polish.md](./ui_ux_polish.md) | Phase 1 implemented (unreleased) | Category need windowing + bars shipped in branch; Phase 2+ ~25 items TBD. Memory/performance changes tracked in same checkpoint (`CHANGELOG` `[Unreleased]`). |
