<!-- Last updated: 2026-07-09 (custom_label_studio v2.48.0; physical smoke gate) -->
# Initiatives index
...
|------------|-------|-------|
| [custom_label_studio](./custom_label_studio.md) | Phases 0–4 + polish shipped (**v2.48.0**); physical smoke gate | Admin Label Studio: templates + AI Create + print × N; print-server **1.4.1**; archive after store smoke. |
