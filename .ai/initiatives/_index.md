<!-- Last updated: 2026-06-23 — Time & payroll, Employees, soft delete -->
# Initiatives index
...
|------------|-------|-------|
| [hr_time_clock_mvp](./hr_time_clock_mvp.md) | MVP rebuild | Time clock, **Employees** admin (pay rate), consolidated **Time & payroll** (roster CRUD, payroll $, change requests approve/reject), soft delete. Legacy HR pages removed. **Session 1** opened 2026-06-22. |
