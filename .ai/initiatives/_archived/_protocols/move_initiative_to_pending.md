...
6. **[`.ai/protocols/session.9.Close.md`](../../../protocols/session.9.Close.md)** — align **`.ai/context.md`**, **`CHANGELOG.md`** `[Unreleased]` (Steering), and extended docs where relevant; **no** repo semver bump for initiative-only moves.
