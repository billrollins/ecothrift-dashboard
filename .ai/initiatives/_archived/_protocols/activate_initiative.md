...
6. **[`.ai/protocols/session.9.Close.md`](../../../protocols/session.9.Close.md)** — align **`.ai/context.md`**, **`CHANGELOG.md`** `[Unreleased]`, and extended docs if the initiative domain is live again.
