...
6. **[`.ai/protocols/session.9.Close.md`](../../../protocols/session.9.Close.md)** — align **`.ai/context.md`**, **`CHANGELOG.md`** `[Unreleased]`, and extended docs where relevant; no semver-only bump for steering-only initiative moves.
