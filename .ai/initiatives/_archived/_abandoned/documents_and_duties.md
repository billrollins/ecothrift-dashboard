...
**Status:** **Abandoned** — replaced by [`routines`](../_completed/routines.md) (completed) and [`documents`](../_pending/documents.md).
...
**Compass:** This file is the compass. [`admin_workspace_overhaul`](../_completed/admin_workspace_overhaul.md) is delivered except deferred grants; [`universal_object_surfaces`](../_pending/universal_object_surfaces.md) stays design-only.
